    ...
    <div className="overflow-hidden relative">
      <section className="bg-gradient-to-br from-[#1a2d57] via-[#2c4a8a] to-[#3a63b8] text-white py-24 md:py-32 pt-32">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            className="absolute -top-24 -right-24 w-96 h-96 bg-blue-400/10 rounded-full"
            variants={bubbleAnimation1}
            animate="animate"
          ></motion.div>

          <motion.div
            className="absolute bottom-10 left-10 w-80 h-80 bg-purple-400/10 rounded-full"
            variants={bubbleAnimation2}
            animate="animate"
          ></motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              Our intelligent platform helps reunite lost items with their
              owners through advanced matching technology.
            </motion.p>
